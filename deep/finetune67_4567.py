...
def train_top_model(X_train, X_test, y_train, y_test):
    ...
    model = util.load_alex_finetune56_finetune567(nb_class=config.nb_class, weights_path=config.alexnet_weights_path,top_model_weight_path="models/0.00001/alex_finetune67_weights" + str(fold_count) + ".h5")
