...
class GoogleImageExtractor(object):
    ...
    def __init__(self, search_key = '' ):
        ...
        self.folder_main_dir_prefix = r'food/google'
    ...
    def retrieve_source_fr_html(self):
        ...
        driver = webdriver.Chrome(executable_path="F:\Downloads\chromedriver_win32\chromedriver.exe", chrome_options=options)
    ...
    def extract_pic_url(self):
        ...
        for tag in tag_list[:self.image_dl_per_search]:
            ...
            try:
                self.pic_url_list.append(urllib.unquote(tar_str.group(1)))
            except:
...
if __name__ == '__main__':
    ...
    if choice ==4:
        ...
        searchlist_filename = r'list.txt'
